...
class Bosses extends PluginBase {
    ...
    public function onEnable() {
        ...
        $vec = $def->getSpawnLocation();
        $def->loadChunk($vec->x >> 4, $vec->z >> 4);
        foreach([
                    new AgentBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new BatBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new BlazeBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new CaveSpiderBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new ChickenBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new CowBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new CreeperBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new DolphinBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new DonkeyBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new ElderGuardianBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new EnderDragonBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new EndermanBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new EndermiteBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new GhastBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new GuardianBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new HorseBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new HuskBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new IronGolemBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new LlamaBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new MagmaCube($def, Entity::createBaseNBT(new Vector3($vec))),
                    new MooshroomBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new MuleBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new NPCBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new OcelotBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new ParrotBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new PhantomBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new PigBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new PolarBearBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new RabbitBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new SheepBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new ShulkerBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new SilverfishBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new SkeletonBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new SkeletonHorseBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new SlimeBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new SnowGolemBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new SpiderBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new SquidBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new StrayBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new VillagerBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new VindicatorBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new WitchBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new WitherBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new WitherSkeletonBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new WolfBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new ZombieBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new ZombieHorseBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new ZombiePigmanBoss($def, Entity::createBaseNBT(new Vector3($vec))),
                    new ZombieVillager($def, Entity::createBaseNBT(new Vector3($vec)))
                ] as $entity)
                        ...
                        $player->sendForm(new CustomForm(
                            ...
                            function(Player $player, CustomFormResponse $response): void {
                                $attributes = BossAttributes::fromArray([
                                    ...
                                    "minionSpawnTickAmount" => $response->getBool("minionspawnseconds")*20,
                            ...
                            function(Player $player, int $i) use ($bosses): void {
                                ...
                                $player->sendForm(new CustomForm(
                                    ...
                                    [
                                        ...
                                        new StepSlider("hitchance", "Hit chance", range(0, 100), $attributes->hitChance),
