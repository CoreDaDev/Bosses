...
class Bosses extends PluginBase {
    ...
    public function onEnable() {
        ...
        foreach([
                    new AgentBoss($def, Entity::createBaseNBT(new Vector3())),
                    new BatBoss($def, Entity::createBaseNBT(new Vector3())),
                    new BlazeBoss($def, Entity::createBaseNBT(new Vector3())),
                    new CaveSpiderBoss($def, Entity::createBaseNBT(new Vector3())),
                    new ChickenBoss($def, Entity::createBaseNBT(new Vector3())),
                    new CowBoss($def, Entity::createBaseNBT(new Vector3())),
                    new CreeperBoss($def, Entity::createBaseNBT(new Vector3())),
                    new DolphinBoss($def, Entity::createBaseNBT(new Vector3())),
                    new DonkeyBoss($def, Entity::createBaseNBT(new Vector3())),
                    new ElderGuardianBoss($def, Entity::createBaseNBT(new Vector3())),
                    new EnderDragonBoss($def, Entity::createBaseNBT(new Vector3())),
                    new EndermanBoss($def, Entity::createBaseNBT(new Vector3())),
                    new EndermiteBoss($def, Entity::createBaseNBT(new Vector3())),
                    new GhastBoss($def, Entity::createBaseNBT(new Vector3())),
                    new GuardianBoss($def, Entity::createBaseNBT(new Vector3())),
                    new HorseBoss($def, Entity::createBaseNBT(new Vector3())),
                    new HuskBoss($def, Entity::createBaseNBT(new Vector3())),
                    new IronGolemBoss($def, Entity::createBaseNBT(new Vector3())),
                    new LlamaBoss($def, Entity::createBaseNBT(new Vector3())),
                    new MagmaCube($def, Entity::createBaseNBT(new Vector3())),
                    new MooshroomBoss($def, Entity::createBaseNBT(new Vector3())),
                    new MuleBoss($def, Entity::createBaseNBT(new Vector3())),
                    new NPCBoss($def, Entity::createBaseNBT(new Vector3())),
                    new OcelotBoss($def, Entity::createBaseNBT(new Vector3())),
                    new ParrotBoss($def, Entity::createBaseNBT(new Vector3())),
                    new PhantomBoss($def, Entity::createBaseNBT(new Vector3())),
                    new PigBoss($def, Entity::createBaseNBT(new Vector3())),
                    new PolarBearBoss($def, Entity::createBaseNBT(new Vector3())),
                    new RabbitBoss($def, Entity::createBaseNBT(new Vector3())),
                    new SheepBoss($def, Entity::createBaseNBT(new Vector3())),
                    new ShulkerBoss($def, Entity::createBaseNBT(new Vector3())),
                    new SilverfishBoss($def, Entity::createBaseNBT(new Vector3())),
                    new SkeletonBoss($def, Entity::createBaseNBT(new Vector3())),
                    new SkeletonHorseBoss($def, Entity::createBaseNBT(new Vector3())),
                    new SlimeBoss($def, Entity::createBaseNBT(new Vector3())),
                    new SnowGolemBoss($def, Entity::createBaseNBT(new Vector3())),
                    new SpiderBoss($def, Entity::createBaseNBT(new Vector3())),
                    new SquidBoss($def, Entity::createBaseNBT(new Vector3())),
                    new StrayBoss($def, Entity::createBaseNBT(new Vector3())),
                    new VillagerBoss($def, Entity::createBaseNBT(new Vector3())),
                    new VindicatorBoss($def, Entity::createBaseNBT(new Vector3())),
                    new WitchBoss($def, Entity::createBaseNBT(new Vector3())),
                    new WitherBoss($def, Entity::createBaseNBT(new Vector3())),
                    new WitherSkeletonBoss($def, Entity::createBaseNBT(new Vector3())),
                    new WolfBoss($def, Entity::createBaseNBT(new Vector3())),
                    new ZombieBoss($def, Entity::createBaseNBT(new Vector3())),
                    new ZombieHorseBoss($def, Entity::createBaseNBT(new Vector3())),
                    new ZombiePigmanBoss($def, Entity::createBaseNBT(new Vector3())),
                    new ZombieVillager($def, Entity::createBaseNBT(new Vector3()))
                ] as $entity)
